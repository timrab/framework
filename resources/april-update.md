...
We had 596 people join our May FinOps Summit. Watch the recording.

In case you missed it: Welcome to @Rob Martin (FinOps Foundation) as our new Director of Learning at the FinOps Foundation!
...
- May 19-20. CLoudLive by CloudHealth.
- May 21  FinOps Open Office Hours
- May 25 Building an Effective FinOps Practice in GCP by Ternary
- May 27th. 3 Cloud Cost Metrics Top SaaS Companies Are Tracking by CloudZero
- see more in #events

Jobs announced last week: 
- Senior Cloud FinOps Engineer at NewRelic (USA).
- FinOps Specialist at NordCloud (Poland)
- Head of FinOps at CloudReach (UK)
- Cloud FinOps Analyst at Comcast (USA)
- Cloud Financial Management Specialist, Cloud Economics at Amazon (USA)
- see more in #jobs

Interesting/relevant conversations:

#shared-cost First draft of the Shared Cost playbook is live!
#aws: Granular cost insights for your multi-tenant applications
#adopting-finops: Business case to have a FinOps employee
#containers-kubernetes We are looking for experts to join the working group...
#adopting-finops Change management around a finops culture
#aws Retention Policies for Snapshots
#googlecloud-gcp: GCE Usage Export
